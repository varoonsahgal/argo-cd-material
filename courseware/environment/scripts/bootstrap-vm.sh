...
#
# Order: pinned tools -> vendored chart + image tarballs -> Docker network ->
# k3d mgmt + workload clusters -> Gitea + users -> seed repos -> Argo CD ->
# in-cluster Secret + workload namespaces -> hello-reconcile Synced/Healthy ->
